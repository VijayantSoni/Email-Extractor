...
public class DocReader 
{
    ...
    static HashSet<String> data;
    
    protected DocReader(File[] file) 
    {
        //Initialize the file array with all the files selected by the user
        this.file = file;
        
        //To store all the email address'
